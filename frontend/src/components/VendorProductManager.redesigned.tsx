  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header className="mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">A central hub for your inventory and listings.</p>
            </div>
        ...
        {showGuide && (
          <Card className="mb-8 bg-blue-50 border-blue-200">
            <div className="p-5 flex flex-col md:flex-row items-start gap-4">
              <div className="text-blue-600 mt-1"><FiInfo className="w-6 h-6" /></div>
              <div className="flex-grow">
                <h3 className="font-semibold text-gray-900 text-lg">Quick Guide: Products vs. Listings</h3>
                <ul className="mt-2 text-sm text-gray-700 list-disc pl-5 space-y-1">
                  <li><span className="font-semibold">Product (Catalog):</span> Reusable item with stock, specs, and images. Ideal for ongoing inventory.</li>
                  <li><span className="font-semibold">Listing (One-off):</span> Ad-style post with price, condition, and location. Best for single items or limited-time offers.</li>
                </ul>
              </div>
              <div className="flex gap-2 self-start md:self-center">
                <Button onClick={() => navigate('/vendor/dashboard#listings')} variant="outline" size="sm">Quick Listing</Button>
                <Button onClick={() => { setShowGuide(false); try { localStorage.setItem('vendor_show_guide', 'false'); } catch {} }} variant="ghost" size="sm">Hide</Button>
              </div>
            </div>
          </Card>
        )}
        ...
        {showAddForm && (
          <Card className="mb-8 animate-slide-in-down p-6">
